...
https://github.com/jakehoare/leetcode/blob/master/python_1_to_1000/012_Integer_to_Roman.py
...
if __name__ == '__main__':
    s = Solution()
    print(s.int_to_roman(3))
    print(s.int_to_roman(4))
    print(s.int_to_roman(9))
